...
'''.format(self.description, self.git_branches, self.git_url, self.configName, self.remoteDirectory, self.sourceFiles, self.execCommand)
    ...
    def jobs_info_dict(config_data):
        ...
        git_branches = config_data['maven2-moduleset']['properties']['hudson.model.ParametersDefinitionProperty']['parameterDefinitions'][
            'com.gem.persistentparameter.PersistentStringParameterDefinition']['defaultValue']
        ssh = config_data['maven2-moduleset']['postbuilders']['jenkins.plugins.publish__over__ssh.BapSshPublisherPlugin'][
            'delegate']['delegate']['publishers']['jenkins.plugins.publish__over__ssh.BapSshPublisher']['configName']
        remote_directory = \
        config_data['maven2-moduleset']['publishers']['jenkins.plugins.publish__over__ssh.BapSshBuilderPlugin'][
        ...
        sourcefiles = \
        config_data['maven2-moduleset']['postbuilders']['jenkins.plugins.publish__over__ssh.BapSshBuilderPlugin'][
            'delegate']['delegate']['publishers']['jenkins.plugins.publish__over__ssh.BapSshPublisher']['transfers'][
